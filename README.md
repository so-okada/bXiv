...
This application bXiv gives arXiv daily new submissions by posts,
abstracts by replies, cross-lists by reposts, and replacements by
quotes and reposts.  We use python3 scripts. bXiv is not affiliated
with arXiv.
